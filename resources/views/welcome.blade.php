                    ...
                    <div class="panel-body">
                        ...
                        <div class="row">
                            <div class="col-xs-4 from">
                                ...
                                <p>Email: <a href="/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="e784888993868493a7839e8988819ec984888a">[email&#160;protected]</a></p>
                            </div>
                            <div class="col-xs-4 to">
                                ...
                                <p>Email: <a href="/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="ed87828583ad898288c38e8280">[email&#160;protected]</a></p>
                            </div>
                        ...
                        <div class="row">
                            ...
                            <form action="{{route('view-pdf')}}" method="post" target="_blank">
                                @csrf
                                    ...
                                    <button class="btn btn-danger"><i class="fa fa-envelope-o"></i> View PDF</button>
                            ...
                            <form action="{{route('download-pdf')}}" method="post" target="_blank">
                                @csrf
                                   ...
                                   <button class="btn btn-success" id="invoice-print"><i class="fa fa-print"></i> Download PDF</button>
